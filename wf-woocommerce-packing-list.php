...
?>
		<a disabled class="button tips wf-packing-list-link" target="_blank" data-tip="<?php
		...
		echo $this->wf_packinglist_get_plugin_url() . '/assets/images/Label-print-icon.png'; ?>" alt="<?php
		esc_attr_e('Print Shipping Label', 'wf-woocommerce-packing-list'); ?>" width="14"></a>

		<a disabled class="button tips " target="_blank" data-tip="<?php
		...
		echo $this->wf_packinglist_get_plugin_url() . '/assets/images/pdf-icon.png'; ?>" alt="<?php
		esc_attr_e('Print Shipping Label', 'wf-woocommerce-packing-list'); ?>" width="14"></a>
...
<div class="wrap">
							...
							<table class="form-table">
								...
								<tr>
									...
									<td><input id="woocommerce_wf_packinglist_logo" type="text" size="36" name="woocommerce_wf_packinglist_logo" value="<?php echo get_option('woocommerce_wf_packinglist_logo'); ?>" />
										<input id="upload_image_button" type="button" value="<?php _e('Upload Image', 'wf-woocommerce-packing-list'); ?>" /><br />
										<span class="description"><?php
								...
								<tr>
									...
									<td>
										...
										<span class="description"><?php
											echo __('Here you can add some policies, conditions etc. For example returns policy. Not exceeding 75 characters. Remains will be discarded.', 'wf-woocommerce-packing-list');
											echo '<br /><strong>' . __('Note:', 'wf-woocommerce-packing-list') . '</strong> ';
								...
								<tr>
									...
									<td>
										...
										<span class="description"><?php
											echo __('Your custom footer for the print. Not exceeding 75 characters. Remains will be discarded.', 'wf-woocommerce-packing-list');
											echo '<br /><strong>' . __('Note:', 'wf-woocommerce-packing-list') . '</strong> ';
	...
	private function wf_pklist_create_order_single_package($order) 
	{
		...
		foreach($order_items as $id => $item) {
			...
			$variation_details = $product->get_type() == 'variation' ? wc_get_formatted_variation($product->variation_data, true) : '';
